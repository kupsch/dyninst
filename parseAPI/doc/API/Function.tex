...
isPLTStub & bool & True if the function is an external linkage stub (an entry in the PLT on ELF) rather than a definition. Such a function forwards to a definition supplied by another object at run time. \\
