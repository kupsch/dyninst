...
//   is_loadable() function in elfutils' elfclassify.c
...
//   True if this object can only be an executable.
//   This function should produce the same result as the
//   is_executable() function in elfutils' elfclassify.c
...
// Object::isExecutable
//   True if this object is an executable, but can also be a shared
//   library (use isSharedLibrary to determine).
//   This function should produce the same result as the
//   is_program() function in elfutils' elfclassify.c
...
//   True if this object is  a shared library, but could also be an
//   executable (use isExecutable to determine).
//   This function should produce the same result as the
//   is_library() function in elfutils' elfclassify.c
...
//   True if this object can only be an shared library.
//   This function should produce the same result as the
//   is_shared() function in elfutils' elfclassify.c
...
//   This function should produce the same result as the
//   is_debug_only() function in elfutils' elfclassify.c
...
//   True if this object only contains debug information for another object.
//   This function should produce the same result as the
//   is_linux_kernel_module() function in elfutils' elfclassify.c
